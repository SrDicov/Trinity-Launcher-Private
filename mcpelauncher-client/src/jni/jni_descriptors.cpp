...
BEGIN_NATIVE_DESCRIPTOR(MainActivity){Constructor<MainActivity>{}},
    ...
    {Function<&MainActivity::setTextBoxBackend>{}, "setTextBoxBackend"},
    {Function<&MainActivity::getTextBoxBackend>{}, "getTextBoxBackend"},
    {Function<&MainActivity::getCursorPosition>{}, "getCursorPosition"},
    {Function<&MainActivity::getCaretPosition>{}, "getCaretPosition"},
    {Function<&MainActivity::setCaretPosition>{}, "setCaretPosition"},
